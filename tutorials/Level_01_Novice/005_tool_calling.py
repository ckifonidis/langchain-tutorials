...
class TimeTool(BaseTool):
    ...
    name: str = "time"
    description: str = "Get current time in specified format (12h or 24h)"
...
def demonstrate_tool_calling():
    ...
    # Convert tools to OpenAI functions using the conversion function.
...
# Third Example (Combined): In London, it's cloudy with a temperature of 18.0°C, and the current time is 02:30 PM.